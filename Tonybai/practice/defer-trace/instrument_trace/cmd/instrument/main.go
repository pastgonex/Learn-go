...
import (
	"flag"
	"fmt"
	"github.com/upupqi/instrument_trace/instrumenter"
	"github.com/upupqi/instrument_trace/instrumenter/ast"
	"io/ioutil"
	"os"
	"path/filepath"
)
...
func main() {
	...
	ins = ast.New("github.com/upupqi/instrument_trace", "trace", "Trace")
